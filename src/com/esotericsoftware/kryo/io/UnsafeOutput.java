...
/**
 * An optimized OutputStream that buffers data in a byte array and optionally flushes to
 * another OutputStream. Utility methods are provided for efficiently writing
...
public final class UnsafeOutput extends Output {
	 ...
	 * 
	 * @param bufferSize
	 *            The initial and maximum size of the buffer. An exception is
	 *            thrown if this size is exceeded.
	 */
	 ...
	 * @param maxBufferSize
	 *            The buffer is doubled as needed until it exceeds maxBufferSize
	...
	/**
	 * Creates a new Output for writing to an OutputStream. A buffer size of
	 * 4096 is used.
	 */
...
//	}
	...
	/***
	 * Output count bytes from a memory region starting at the given #{offset}
	 * inside the in-memory representation of obj object.
	 * @param obj
	 * @param offset
	 * @param count
	 */
	...
	final private void writeBytes(Object srcArray, long srcArrayTypeOffset,
			long srcOffset, long count) throws KryoException {
