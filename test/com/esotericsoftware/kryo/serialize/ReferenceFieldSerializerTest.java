...
public class ReferenceFieldSerializerTest extends KryoTestCase {
	...
	public void testNonStaticInnerClassPublicConstructor () {
		Kryo kryo = new Kryo() {
			protected Serializer newDefaultSerializer (Class type) {
				return new ReferenceFieldSerializer(this, type);
			}
		};
		kryo.register(OuterClassPublicConstructor.class);
		kryo.register(OuterClassPublicConstructor.InnerClassPublicConstructor.class);
		OuterClassPublicConstructor outerClass = new OuterClassPublicConstructor();
	...
	public void testNonStaticInnerClassPrivateConstructor () {
		Kryo kryo = new Kryo() {
			protected Serializer newDefaultSerializer (Class type) {
				return new ReferenceFieldSerializer(this, type);
			}
		};
		kryo.register(OuterClassPrivateConstructor.class);
		kryo.register(OuterClassPrivateConstructor.InnerClassPrivateConstructor.class);
		OuterClassPrivateConstructor outerClass = new OuterClassPrivateConstructor();
		outerClass.something = "meow";
		outerClass.innerClass.somethingElse = "moo";
		roundTrip(kryo, 18, outerClass);
		roundTrip(kryo, 21, outerClass.innerClass);
	...
	static public class OuterClassPublicConstructor {
		public InnerClassPublicConstructor innerClass = new InnerClassPublicConstructor();
		public String something;

		public class InnerClassPublicConstructor {
			...
			public boolean equals (Object obj) {
				...
				InnerClassPublicConstructor other = (InnerClassPublicConstructor)obj;
		...
		public boolean equals (Object obj) {
			...
			if (obj == null) return false;
			if (getClass() != obj.getClass()) return false;
			OuterClassPublicConstructor other = (OuterClassPublicConstructor)obj;
			if (innerClass == null) {
	...
	static public class OuterClassPrivateConstructor {
		public InnerClassPrivateConstructor innerClass = new InnerClassPrivateConstructor();
		public String something;

		class InnerClassPrivateConstructor {
			public String somethingElse;

			InnerClassPrivateConstructor () {
			}
			...
			public boolean equals (Object obj) {
				...
				if (obj == null) return false;
				if (getClass() != obj.getClass()) return false;
				InnerClassPrivateConstructor other = (InnerClassPrivateConstructor)obj;
				if (somethingElse == null) {
					if (other.somethingElse != null) return false;
				} else if (!somethingElse.equals(other.somethingElse)) return false;
				return true;
		...
		public boolean equals (Object obj) {
			...
			if (obj == null) return false;
			if (getClass() != obj.getClass()) return false;
			OuterClassPrivateConstructor other = (OuterClassPrivateConstructor)obj;
			if (innerClass == null) {
				if (other.innerClass != null) return false;
			} else if (!innerClass.equals(other.innerClass)) return false;
			if (something == null) {
